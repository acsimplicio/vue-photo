...
GREEN='\033[00;32m'
YELLOW='\e[0;33m'
HOST_PROD=vue-photo.example.com
...
workon vue-photo  # Change this to your project's name
...
function dknpminstall {
    CD=$(pwd)
    cd $PROJ_BASE
    docker run -it --rm -v $(pwd):/app -w /app/frontend -e NODE_ENV=development vue-photo npm install
    exitcode=$?
    cd $CD
    return $exitcode
}
...
function dkrun_prod {
    docker stop vue-photo
    docker rm vue-photo
    docker run --name vue-photo -d --env-file /home/ubuntu/vue-photo.env \
        -p 3000:3000 -p 8000:8000 \
        -v /home/ubuntu/dkdata/vue-photo:/dkdata \
        vue-photo start_web.sh
}
...
echo_green "Welcome to vue-photo's dev env"
