"""
Django settings for vue-photo project.
...
WSGI_APPLICATION = 'vue-photo.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './vue-photo.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
